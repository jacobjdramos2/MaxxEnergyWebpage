...
const API_BASE = process.env.REACT_APP_API_BASE || ''; // '' if using CRA proxy
      ...
      <form onSubmit={onSubmit} noValidate>
        <div style={{ marginBottom: 12 }}>
          ...
          <input id="firstName" name="firstName" value={form.firstName} onChange={onChange}
                 ...
                 aria-describedby="firstName-error" required />
          {errors.firstName && <div id="firstName-error" style={{ color: 'crimson', fontSize: 12 }}>{errors.firstName}</div>}
        </div>
        ...
        <div style={{ marginBottom: 12 }}>
          ...
          <input id="lastName" name="lastName" value={form.lastName} onChange={onChange}
                 ...
                 aria-describedby="lastName-error" required />
          {errors.lastName && <div id="lastName-error" style={{ color: 'crimson', fontSize: 12 }}>{errors.lastName}</div>}
        </div>
        ...
        <div style={{ marginBottom: 12 }}>
          ...
          {errors.email && <div id="email-error" style={{ color: 'crimson', fontSize: 12 }}>{errors.email}</div>}
        </div>

        <div style={{ marginBottom: 16 }}>
          <label htmlFor="confirmEmail">Confirm email</label><br />
          <input id="confirmEmail" name="confirmEmail" type="email" value={form.confirmEmail} onChange={onChange}
                 autoComplete="email" aria-invalid={!!errors.confirmEmail}
                 aria-describedby="confirmEmail-error" required />
          {errors.confirmEmail && <div id="confirmEmail-error" style={{ color: 'crimson', fontSize: 12 }}>{errors.confirmEmail}</div>}
        </div>
        ...
        <div style={{ marginBottom: 12 }}>
          ...
          {errors.password && <div id="password-error" style={{ color: 'crimson', fontSize: 12 }}>{errors.password}</div>}
        </div>
        ...
        <div style={{ marginBottom: 12 }}>
          ...
          <input id="confirmPassword" name="confirmPassword" type={showPassword ? 'text' : 'password'}
                 ...
                 aria-describedby="confirmPassword-error" required />
          {errors.confirmPassword && <div id="confirmPassword-error" style={{ color: 'crimson', fontSize: 12 }}>{errors.confirmPassword}</div>}
        </div>
